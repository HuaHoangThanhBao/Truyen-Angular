...
import { ForgotPasswordDto } from '../../model/authentication/forgotPasswordDto.model';


@Injectable({ providedIn: 'root' })
export class ForgotPasswordService extends ResourceService<ForgotPasswordDto> {
